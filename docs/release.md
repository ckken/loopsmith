...
6. 验证 release：
   ...
   gh release download v0.3.1 -R ckken/loopsmith -D /tmp/loopsmith-release
   ```
...
```bash
gh release download v0.3.1 -R ckken/loopsmith -p 'loopsmith-v0.3.1-x86_64-unknown-linux-gnu.tar.gz'
tar -xzf loopsmith-v0.3.1-x86_64-unknown-linux-gnu.tar.gz
sudo install -m 0755 loopsmith-v0.3.1-x86_64-unknown-linux-gnu/loopsmith /usr/local/bin/loopsmith
```

macOS Intel：

```bash
gh release download v0.3.1 -R ckken/loopsmith -p 'loopsmith-v0.3.1-x86_64-apple-darwin.tar.gz'
tar -xzf loopsmith-v0.3.1-x86_64-apple-darwin.tar.gz
sudo install -m 0755 loopsmith-v0.3.1-x86_64-apple-darwin/loopsmith /usr/local/bin/loopsmith
```

Windows x86_64：

```powershell
gh release download v0.3.1 -R ckken/loopsmith -p 'loopsmith-v0.3.1-x86_64-pc-windows-msvc.zip'
Expand-Archive loopsmith-v0.3.1-x86_64-pc-windows-msvc.zip
$env:Path += ";$PWD\loopsmith-v0.3.1-x86_64-pc-windows-msvc"
